...
(function () {
    try {
        ...
        css.textContent =
            ...
            'background:radial-gradient(circle at center,#0a1014 0%,#050505 100%);}' +
            '.nadiya-bg .g{position:absolute;width:200%;height:200%;top:-50%;left:-50%;' +
            'background-image:linear-gradient(rgba(32,201,151,.03) 1px,transparent 1px),linear-gradient(90deg,rgba(32,201,151,.03) 1px,transparent 1px);' +
